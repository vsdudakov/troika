...
Worktree: `$WS/llm/worktrees/toyapp-TOY-1` — created (no existing lane held it)
...
- `migrations/0001_initial.py` — added `ix_holding_symbol`; the per-symbol rollup scans
  `holding.symbol` and there was no index on it
