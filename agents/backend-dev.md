...
`$TROIKA_SCRATCHPAD/plans/<TICKET>.md` — take only the requirements and work items for your repo, including the pinned contract you must implement exactly.
...
Write `$TROIKA_SCRATCHPAD/plans/<TICKET>-backend-dev.md`: branch · worktree/create-or-join · files · test node IDs→sources · verification/results · actual contract · gaps. No test results.
