...
Run Troika's **release-cut** procedure for: $ARGUMENTS
...
2. Read the procedure: `${CLAUDE_PLUGIN_ROOT}/skills/release-cut/SKILL.md`. If that
   variable is unset, read `$TROIKA_HOME/skills/release-cut/SKILL.md` instead.
