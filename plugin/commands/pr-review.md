...
Run Troika's **pr-review** procedure for: $ARGUMENTS
...
2. Read the procedure: `${CLAUDE_PLUGIN_ROOT}/skills/pr-review/SKILL.md`. If that
   variable is unset, read `$TROIKA_HOME/skills/pr-review/SKILL.md` instead.
