...
Run Troika's **develop-flow** procedure for: $ARGUMENTS
...
2. Read the procedure: `${CLAUDE_PLUGIN_ROOT}/skills/develop-flow/SKILL.md`. If that
   variable is unset, read `$TROIKA_HOME/skills/develop-flow/SKILL.md` instead.
