...
Run Troika's **qa-verify** procedure for: $ARGUMENTS
...
2. Read the procedure: `${CLAUDE_PLUGIN_ROOT}/skills/qa-verify/SKILL.md`. If that
   variable is unset, read `$TROIKA_HOME/skills/qa-verify/SKILL.md` instead.
